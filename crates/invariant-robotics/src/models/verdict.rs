...
///
/// ```
/// use invariant_robotics::models::verdict::{Verdict, CheckResult, AuthoritySummary};
///
/// let verdict = Verdict {
///     approved: true,
...
///
/// ```
/// use invariant_robotics::models::verdict::ThreatAnalysis;
///
...
///
/// ```
/// use invariant_robotics::models::verdict::CheckResult;
///
...
///
/// ```
/// use invariant_robotics::models::verdict::DeratingAdvice;
///
...
///
/// ```
/// use invariant_robotics::models::verdict::AuthoritySummary;
///
