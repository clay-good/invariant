...
// Re-export shared protocol modules from invariant-core so existing
// downstream code referring to `crate::models::authority::*` or
// `crate::models::error::*` keeps working.
pub use invariant_core::models::{authority, error};
...
mod tests {
    ...
    fn deserialize_humanoid_profile() {
        let json = include_str!("../../../../profiles/robotics/humanoid_28dof.json");
