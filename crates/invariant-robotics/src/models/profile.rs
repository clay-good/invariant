...
///
/// ```
/// use invariant_robotics::models::profile::JointType;
///
...
///
/// ```
/// use invariant_robotics::models::profile::BoundsType;
///
...
///
/// ```
/// use invariant_robotics::models::profile::SafeStopStrategy;
///
...
///
/// ```
/// use invariant_robotics::models::profile::CollisionPair;
///
...
///
/// ```
/// use invariant_robotics::models::profile::{JointDefinition, JointType};
/// use invariant_robotics::models::error::{Validate, ValidationError};
///
...
impl invariant_core::DomainProfile for RobotProfile {
    fn id(&self) -> &str {
        &self.name
    }
