...
mod tests {
    ...
    fn run_all_checks_returns_10_results() {
        ...
        // 11 P-checks + SR2 (payload sensor-range) = 12 results.
        ...
        assert_eq!(
            ...
            vec![
                ...
                crate::physics::environment::SR2_CHECK_NAME,
            ]
        );
    }
    ...
    fn env_checks_skip_p21_p24_when_config_absent() {
        ...
        assert_eq!(results[0].name, crate::physics::environment::SR1_CHECK_NAME);
