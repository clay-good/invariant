...
const HUMANOID_28DOF_JSON: &str = include_str!("../../../profiles/robotics/humanoid_28dof.json");
const FRANKA_PANDA_JSON: &str = include_str!("../../../profiles/robotics/franka_panda.json");
const QUADRUPED_12DOF_JSON: &str = include_str!("../../../profiles/robotics/quadruped_12dof.json");
const UR10_JSON: &str = include_str!("../../../profiles/robotics/ur10.json");
const UR10E_HAAS_CELL_JSON: &str = include_str!("../../../profiles/robotics/ur10e_haas_cell.json");
const UR10E_CNC_TENDING_JSON: &str = include_str!("../../../profiles/robotics/ur10e_cnc_tending.json");
const UNITREE_H1_JSON: &str = include_str!("../../../profiles/robotics/unitree_h1.json");
const UNITREE_G1_JSON: &str = include_str!("../../../profiles/robotics/unitree_g1.json");
const SPOT_JSON: &str = include_str!("../../../profiles/robotics/spot.json");
const KUKA_IIWA14_JSON: &str = include_str!("../../../profiles/robotics/kuka_iiwa14.json");
const KINOVA_GEN3_JSON: &str = include_str!("../../../profiles/robotics/kinova_gen3.json");
const ABB_GOFA_JSON: &str = include_str!("../../../profiles/robotics/abb_gofa.json");
const SHADOW_HAND_JSON: &str = include_str!("../../../profiles/robotics/shadow_hand.json");
const FOURIER_GR1_JSON: &str = include_str!("../../../profiles/robotics/fourier_gr1.json");
const TESLA_OPTIMUS_JSON: &str = include_str!("../../../profiles/robotics/tesla_optimus.json");
const FIGURE_02_JSON: &str = include_str!("../../../profiles/robotics/figure_02.json");
const BD_ATLAS_JSON: &str = include_str!("../../../profiles/robotics/bd_atlas.json");
const AGILITY_DIGIT_JSON: &str = include_str!("../../../profiles/robotics/agility_digit.json");
const SANCTUARY_PHOENIX_JSON: &str = include_str!("../../../profiles/robotics/sanctuary_phoenix.json");
const ONEX_NEO_JSON: &str = include_str!("../../../profiles/robotics/onex_neo.json");
const APPTRONIK_APOLLO_JSON: &str = include_str!("../../../profiles/robotics/apptronik_apollo.json");
const UNITREE_GO2_JSON: &str = include_str!("../../../profiles/robotics/unitree_go2.json");
const ANYBOTICS_ANYMAL_JSON: &str = include_str!("../../../profiles/robotics/anybotics_anymal.json");
const ALLEGRO_HAND_JSON: &str = include_str!("../../../profiles/robotics/allegro_hand.json");
const LEAP_HAND_JSON: &str = include_str!("../../../profiles/robotics/leap_hand.json");
const PSYONIC_ABILITY_JSON: &str = include_str!("../../../profiles/robotics/psyonic_ability.json");
const UNITREE_A1_JSON: &str = include_str!("../../../profiles/robotics/unitree_a1.json");
const SPOT_WITH_ARM_JSON: &str = include_str!("../../../profiles/robotics/spot_with_arm.json");
const HELLO_STRETCH_JSON: &str = include_str!("../../../profiles/robotics/hello_stretch.json");
const PAL_TIAGO_JSON: &str = include_str!("../../../profiles/robotics/pal_tiago.json");
const ADV_ZERO_MARGIN_JSON: &str = include_str!("../../../profiles/robotics/adversarial_zero_margin.json");
const ADV_MAX_WORKSPACE_JSON: &str = include_str!("../../../profiles/robotics/adversarial_max_workspace.json");
const ADV_SINGLE_JOINT_JSON: &str = include_str!("../../../profiles/robotics/adversarial_single_joint.json");
const ADV_MAX_JOINTS_JSON: &str = include_str!("../../../profiles/robotics/adversarial_max_joints.json");
