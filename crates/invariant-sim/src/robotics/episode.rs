...
use invariant_robotics::models::audit::{AuditEntry, SignedAuditEntry};
...
/// use invariant_sim::robotics::episode::{EpisodeOutput, VerdictChainBuilder};
/// use invariant_robotics::models::trace::Trace;
///
...
impl EpisodeOutput {
    ...
    /// ```
    /// use std::collections::HashMap;
    /// use invariant_sim::robotics::episode::EpisodeOutput;
    /// use invariant_robotics::models::trace::Trace;
    ///
    /// let trace = Trace {
    ///     id: "ep-1".to_string(),
...
/// use rand::rngs::OsRng;
/// use invariant_sim::robotics::episode::VerdictChainBuilder;
///
...
impl VerdictChainBuilder {
    ...
    /// use rand::rngs::OsRng;
    /// use invariant_sim::robotics::episode::VerdictChainBuilder;
    /// use invariant_robotics::models::command::{Command, CommandAuthority};
...
mod tests {
    ...
    use ed25519_dalek::SigningKey;
    use invariant_robotics::models::command::{Command, CommandAuthority};
    use invariant_robotics::models::verdict::{AuthoritySummary, SignedVerdict, Verdict};
    use rand::rngs::OsRng;
    use std::collections::HashMap;
