...
///
/// ```
/// use invariant_eval::robotics::presets::list_presets;
///
...
///
/// ```
/// use invariant_eval::robotics::presets::{EvalFinding, Severity};
///
...
///
/// ```
/// use invariant_eval::robotics::presets::Severity;
///
...
///
/// ```
/// use invariant_eval::robotics::presets::{EvalReport, EvalFinding, Severity};
///
...
/// use invariant_eval::robotics::presets::{run_preset, list_presets};
...
/// ```
/// use std::collections::HashMap;
/// use invariant_eval::robotics::presets::run_regression;
/// use invariant_robotics::models::trace::{Trace, TraceStep};
/// use invariant_robotics::models::command::{Command, CommandAuthority, JointState};
/// use invariant_robotics::models::verdict::{SignedVerdict, Verdict, CheckResult, AuthoritySummary};
///
