...
///
/// ```
/// use invariant_eval::robotics::rubric::RubricRule;
///
...
///
/// ```
/// use invariant_eval::robotics::rubric::{Rubric, RubricRule};
///
/// let rubric = Rubric {
...
use super::presets::{EvalFinding, EvalReport, Severity};
...
/// use invariant_eval::robotics::rubric::{Rubric, RubricRule, run_rubric};
...
///
/// ```
/// use invariant_eval::robotics::rubric::load_rubric_json;
///
