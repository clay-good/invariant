...
use invariant_robotics::models::authority::Pca;
...
mod tests {
    ...
    use invariant_robotics::models::authority::{Operation, SignedPca};
    ...
    fn forge_authority_chain_validates_with_matching_key() {
        ...
        let sk_for_config = invariant_robotics::authority::crypto::generate_keypair(&mut OsRng);
