...
///
/// ```
/// use invariant_fuzz::robotics::cognitive::escape::EscapeResult;
///
...
///
/// ```
/// use invariant_fuzz::robotics::cognitive::escape::ce1_gradual_drift;
/// use invariant_robotics::models::profile::{RobotProfile, JointDefinition, JointType,
